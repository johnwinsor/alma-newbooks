...
def getBooks():
    count = 0
    books = []
    almaUrl = "https://api-na.hosted.exlibrisgroup.com/almaws/v1/analytics/reports?path=%2Fshared%2FNortheastern%20University%2FJohnShared%2FAPI%2FNewBooksWeb&limit=100&apikey={almaKey}"
